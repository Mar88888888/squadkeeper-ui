...
export function ConfirmDialog({
  ...
  const variantStyles = {
    warning: {
      ...
      confirmButton: 'bg-amber-600 hover:bg-amber-700 focus:ring-amber-200 dark:focus:ring-amber-900',
    },
    danger: {
      icon: (
      ...
      confirmButton: 'bg-red-600 hover:bg-red-700 focus:ring-red-200 dark:focus:ring-red-900',
    },
    info: {
      icon: (
      ...
      confirmButton: 'bg-blue-600 hover:bg-blue-700 focus:ring-blue-200 dark:focus:ring-blue-900',
    },
  };
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div
          ref={dialogRef}
          className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-900 shadow-2xl transition-all animate-in fade-in zoom-in-95 duration-200"
