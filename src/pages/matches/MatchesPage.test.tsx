...
describe('MatchesPage', () => {
  ...
  describe('Create Match Modal', () => {
    ...
    it('should create match on form submit', async () => {
      ...
      const submitButton = scheduleButtons.find(
        (btn) => btn.textContent === 'Schedule',
      );
      if (submitButton) {
  ...
  describe('Filters', () => {
    ...
    it('should show group filter dropdown', async () => {
      ...
      await waitFor(() => {
        const allGroups =
          screen.queryByText('All Groups') || screen.queryByText('All groups');
  ...
  describe('Error handling', () => {
    ...
    it('should show error message on API failure', async () => {
      ...
      await waitFor(() => {
        const errorElement =
          screen.queryByText('Failed to load matches') ||
