          ...
          {user?.role === UserRole.COACH && (
            <div className="border-t border-gray-200 pt-8 mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Link
                  to="/analytics/chemistry"
                  className="bg-cyan-50 hover:bg-cyan-100 rounded-xl p-6 transition-colors group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Team Chemistry</p>
                      <p className="text-sm text-gray-600">Best player combinations</p>
                    </div>
                  </div>
                </Link>
              </div>
